		...
		<div id="profile4" class="tab-pane in active">
			...
			<div class="row">
				...
				<div style="margin-left:10px">
													<span class="a">
		<a href="#" onclick="document.location.href='new_prob.php?course_id='+<?php echo $cid; ?>" class="btn btn-primary btn-sm">New</a>
...
-->
		...
		<script>
			...
			$("tr").click(function ()
			{
				...
				$("#e").click(function()
				{
					var base_url="http://localhost/compiler_mast/misnew/prob_edit.php";
					var full_url=base_url+"?problem_id="+a;
					window.location=full_url;
				});
				$("#d").click(function()
				{
					var base_url="http://localhost/compiler_mast/misnew/prob_delete.php";
					var full_url=base_url+"?problem_id="+a;
					window.location=full_url;
				});
				$("#mav").click(function()
				{
					var base_url="http://localhost/compiler_mast/misnew/prob_mav.php";
					var full_url=base_url+"?problem_id="+a;
					window.location=full_url;
				});
				$("#mai").click(function()
				{
					var base_url="http://localhost/compiler_mast/misnew/prob_mai.php";
					var full_url=base_url+"?problem_id="+a;
					window.location=full_url;
				});
				$("#sh").click(function()
				{
					var base_url="http://localhost/compiler_mast/misnew/prob_share.php";
					var full_url=base_url+"?problem_id="+a;
					window.location=full_url;
					});
