			...
			<div class="row">
				<div><!--form start-->
					<form action="" method="post" class="form-horizontal" role="form">
						...
						<right>		<input style="margin-left:10px;" class="btn btn-info" type="submit" name="refresh" value="Refresh">
								<a style="margin-left:10px;" class="btn btn-info" id="e">Load Exercise</a></right>
								<br>
								...
								$cid=$_SESSION['cid'];
								$v = 1;
								$query=mysql_query("select * from cc_problems where course_id='$cid' and visible='$v';");
								?>
...
console.log("sfdsf");
						...
						$("tr").click(function ()
						{
							...
							$("#e").click(function()
							{
								var base_url="http://localhost/compiler_mast/user/code1.php";
