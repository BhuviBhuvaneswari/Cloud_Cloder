		...
		if(isset($_POST['submit']))
			{
				...
				$query3=mysql_query("update cc_user set username='$uname', firstname='$fname', lastname='$lname',
				email='$email1' , password='$password1' where user_id='$id'");
				if($query3)
					{
						header('Location:manage_user.php');
					}
			}
		$query=mysql_query("select * from cc_user where user_id='$id'");
								...
								<div><!--form start-->
									...
									<div class="col-sm-12">
											...
											<div class="form-group" >
												...
												<div class="col-sm-9">
													<input type="text" name="password" class="col-xs-6 col-sm-4" value="<?php echo $row['password']; ?>" />
												</div>
											</div>
